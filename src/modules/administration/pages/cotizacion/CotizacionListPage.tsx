...
export const CotizacionListPage = () => {
    ...
    const {content, totalElements, findAll, remove} = useCotizacionListStore();
    ...
    return (
        <>
            ...
            <SearchBarLayout
                ...
                onSubmit={async ({inicioFechaCreacion, finFechaCreacion, inicioFechaVencimiento, finFechaVencimiento}) =>
                    {
                        setPage(0);
                        await findAll(0, inicioFechaCreacion, finFechaCreacion, inicioFechaVencimiento, finFechaVencimiento);
                    }}
                onClean={() => findAll()}
            >
                <CustomDatePicker label={'Inicio fecha de creación'} name={'inicioFechaCreacion'} xs={12}/>
                <CustomDatePicker label={'Fin fecha de creación'} name={'finFechaCreacion'} xs={12}
