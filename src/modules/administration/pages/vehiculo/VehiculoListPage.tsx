...
export const VehiculoListPage = () => {
    ...
    const {content, totalElements, findAll, remove} = useVehiculoListStore();
    ...
    return (
        <>
            ...
            <SearchBarLayout
                ...
                onSubmit={async ({placa, chasis, color, kilometraje}) => {
                  setPage(0);
                  await findAll(0, placa, chasis, color, kilometraje);
                }}
                onClean={() => findAll()}
            >
